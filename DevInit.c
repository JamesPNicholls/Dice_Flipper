...
//                  Initialized GPIO6 to 0  (Set GpioDataRegs.GPACLEAR.bit.GPIO6 = 1)
// Search for "LK" for changes
//============================================================================
//============================================================================
...
// Refer to the datasheet for your particular device. 
   ...
   //------------------------------------------------
   // Enable TBCLK
   SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 1;   // LK
   //------------------------------------------------
...
//  GPIO-06 - PIN FUNCTION = --Spare--
	// ePWM4A J2PIN 8
	GpioCtrlRegs.GPAMUX1.bit.GPIO6 = 1;		// 0=GPIO,  1=EPWM4A,  2=SYNCI,  3=SYNCO    // LK
